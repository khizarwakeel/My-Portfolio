    ...
    <>
      ...
      >
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          className="w-8 h-8 text-white hover:text-fuchsia-500 cursor-pointer outline-none z-40"
        >
          <path
      ...
      {isOpen && (
        <div
          ...
          }  fixed bg-gradient-to-r from-[#5d109e] via-[#741ac1] shadow-2xl to-[#5d109e] w-[100vw] md:w-[45vw] lg:w-[32vw] xl:w-[25vw] h-screen pt-4`}
        >
          <button
            onClick={() => {
              setIsOpen(!isOpen);
          ...
          >
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-8 h-8 text-white hover:text-fuchsia-400 cursor-pointer ml-4 outline-none"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
